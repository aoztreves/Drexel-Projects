...
public class Operator extends Token {
	...
	protected int getPrec()
	{
		...
		if(val == opType.ADD){return 1;}
		else if(val == opType.SUB){return 1;}
		else if(val == opType.MULT){return 2;}
		else if(val == opType.DIV){return 2;}
		else if(val ==	opType.MOD){return 2;}
		else if(val == opType.LPAR){return 3;}
		else if(val == opType.RPAR){return 3;}	
		return 0;
	}
